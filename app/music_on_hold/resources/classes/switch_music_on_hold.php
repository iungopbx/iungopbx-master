	...
	class switch_music_on_hold {
		...
		public function save() {
			//get the contents of the template
				if (file_exists('/usr/share/examples/iungopbx')) {
					$file_contents = file_get_contents("/usr/share/examples/iungopbx/resources/templates/conf/autoload_configs/local_stream.conf.xml");
				}
				else {
