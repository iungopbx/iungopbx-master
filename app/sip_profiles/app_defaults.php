...
//if the number of rows is 0 then read the sip profile xml into the database
	if ($domains_processed == 1) {
		...
		//add the sip profiles to the database
			...
			if ($num_rows == 0) {
				if (file_exists('/usr/share/examples/iungopbx/resources/templates/conf/sip_profiles')) {
					$sip_profile_dir = '/usr/share/examples/iungopbx/resources/templates/conf/sip_profiles/*.xml.noload';
				}
				elseif (file_exists('/usr/local/share/iungopbx/resources/templates/conf/sip_profiles')) {
					$sip_profile_dir = '/usr/local/share/iungopbx/resources/templates/conf/sip_profiles/*.xml.noload';
				}
				else {
