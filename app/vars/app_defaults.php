...
if ($domains_processed == 1) {
	...
	//add the variables to the database
		...
		if ($num_rows == 0) {
			//get the xml
				if (file_exists('/usr/share/examples/iungopbx/resources/templates/conf/vars.xml')) {
					$xml_file = '/usr/share/examples/iungopbx/resources/templates/conf/vars.xml';
				}
				elseif (file_exists('/usr/local/share/iungopbx/resources/templates/conf/vars.xml')) {
					$xml_file = '/usr/local/share/iungopbx/resources/templates/conf/vars.xml';
				}
				else {
