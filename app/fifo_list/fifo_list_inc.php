...
//show the list
	...
	if ($fp) {
		...
		/*
		<fifo_report>
		  <fifo name="5900@voip.iungo.cloud" consumer_count="0" caller_count="1" waiting_count="1" importance="0">
			<callers>
		  ...
		  <fifo name="cool_fifo@voip.iungo.cloud" consumer_count="0" caller_count="0" waiting_count="0" importance="0">
			<callers></callers>
			<consumers></consumers>
		  </fifo>
		</fifo_report>
