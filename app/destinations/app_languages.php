...
$text['billing-warning']['en-us'] = "If you are using iungopbx billing application, make sure to add accountcode and carrier variables.";
$text['billing-warning']['en-gb'] = "If you are using iungopbx billing application, make sure to add accountcode and carrier variables.";
$text['billing-warning']['ar-eg'] = "";
$text['billing-warning']['de-at'] = "Wenn Sie die Iungopbx Abrechnung verwenden, stellen Sie sicher, dass Account-Code und Betreiber-Variablen gesetzt sind."; //copied from de-de
$text['billing-warning']['de-ch'] = "Wenn Sie die Iungopbx Abrechnung verwenden, stellen Sie sicher, dass Account-Code und Betreiber-Variablen gesetzt sind."; //copied from de-de
$text['billing-warning']['de-de'] = "Wenn Sie die Iungopbx Abrechnung verwenden, stellen Sie sicher, dass Account-Code und Betreiber-Variablen gesetzt sind.";
$text['billing-warning']['es-cl'] = "Si está utilizando la aplicación de facturación iungopbx, asegúrese de agregar lasvariables accountcode y carrier";
$text['billing-warning']['es-mx'] = "Si está utilizando la aplicación de facturación iungopbx, asegúrese de agregar lasvariables accountcode y carrier"; //copied from es-cl
$text['billing-warning']['fr-ca'] = "Si vous utilisez l'application de facturation iungopbx, assurez-vous d'ajouter des variables de accountcode et carrier"; //copied from fr-fr
$text['billing-warning']['fr-fr'] = "Si vous utilisez l'application de facturation iungopbx, assurez-vous d'ajouter des variables de accountcode et carrier";
$text['billing-warning']['he-il'] = "";
$text['billing-warning']['it-it'] = "Se si usa l'applicazione per la fatturazione di iungopbx, accertarsi di valorizzare accountcode e carrier.";
$text['billing-warning']['nl-nl'] = "Als je iungopbx doorbelastingen applicatie gebruikt, zorg dan dat account code en Telco variabelen in gevuld zijn.";
$text['billing-warning']['pl-pl'] = "Jeżeli używasz platformę billingowa z Iungopbx, dodaj numer konta billingowego oraz zmienne operatora";
...
$text['billing-warning']['pt-pt'] = "Se você estiver usando o aplicativo de faturamento iungopbx, certifique-se de adicionar variáveis accountcode e carrier";
$text['billing-warning']['ro-ro'] = "";
$text['billing-warning']['ru-ru'] = "Если вы используете приложение биллинга IungoPBX, обязательно добавьте код учетной записи и переменные-несущие.";
$text['billing-warning']['sv-se'] = "Om du använder iungopbx fakturering program, se till att lägga till 'account code' och operatör variabler";
$text['billing-warning']['uk-ua'] = "Якщо ви користуєтеся додатком для тарифікації в iungopbx, то переконайтеся, щоб додано змінні код облікового запису і оператора. ";
