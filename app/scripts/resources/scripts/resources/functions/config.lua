...
--find and return path to the config.conf
	function config()
		if (file_exists("/usr/local/etc/iungopbx/config.conf")) then
			return "/usr/local/etc/iungopbx/config.conf";
		elseif (file_exists("/etc/iungopbx/config.conf")) then
			return "/etc/iungopbx/config.conf";
		else
