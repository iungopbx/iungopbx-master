...
--prepare the headers
	headers = {}
	headers["X-IungoPBX-Domain-UUID"] = domain_uuid;
	headers["X-IungoPBX-Domain-Name"] = domain_name;
	headers["X-IungoPBX-Email-Type"]  = email_type;
	headers["X-IungoPBX-Email-From"]  = from_address;
	headers["X-IungoPBX-Call-UUID"] = uuid;
