--
-- Name: agents; Type: TABLE; Schema: public; Owner: iungopbx; Tablespace:
--
CREATE TABLE agents (
   uuid uuid,
...
ALTER TABLE agents OWNER TO iungopbx;
...
ALTER TABLE aliases OWNER TO iungopbx;
...
ALTER TABLE calls OWNER TO iungopbx;
...
ALTER TABLE channels OWNER TO iungopbx;
...
ALTER TABLE complete OWNER TO iungopbx;
...
ALTER TABLE db_data OWNER TO iungopbx;
...
ALTER TABLE fifo_outbound OWNER TO iungopbx;
...
ALTER TABLE fifo_bridge OWNER TO iungopbx;
...
ALTER TABLE fifo_callers OWNER TO iungopbx;
...
ALTER TABLE group_data OWNER TO iungopbx;
...
ALTER TABLE interfaces OWNER TO iungopbx;
...
ALTER TABLE limit_data OWNER TO iungopbx;

--
-- Name: members; Type: TABLE; Schema: public; Owner: iungopbx; Tablespace:
--
...
ALTER TABLE members OWNER TO iungopbx;
...
ALTER TABLE nat OWNER TO iungopbx;
...
ALTER TABLE recovery OWNER TO iungopbx;
...
ALTER TABLE registrations OWNER TO iungopbx;
...
ALTER TABLE sip_registrations OWNER TO iungopbx;
...
ALTER TABLE sip_authentication OWNER TO iungopbx;
...
ALTER TABLE sip_dialogs OWNER TO iungopbx;
...
ALTER TABLE sip_presence OWNER TO iungopbx;
...
ALTER TABLE sip_shared_appearance_dialogs OWNER TO iungopbx;
...
ALTER TABLE sip_shared_appearance_subscriptions OWNER TO iungopbx;
...
ALTER TABLE sip_subscriptions OWNER TO iungopbx;
...
ALTER TABLE tasks OWNER TO iungopbx;

--
-- Name: tiers; Type: TABLE; Schema: public; Owner: iungopbx; Tablespace:
--
CREATE TABLE tiers (
   queue character varying(255),
...
ALTER TABLE tiers OWNER TO iungopbx;


--
-- Name: json_store; Type: TABLE; Schema: public; Owner: iungopbx; Tablespace:
--
CREATE TABLE json_store (
 ...
 ALTER TABLE json_store OWNER TO iungopbx;
  
--Create Views

-- Name: basic_calls; Type: VIEW; Schema: public; Owner: iungopbx
...
ALTER TABLE basic_calls OWNER TO iungopbx;

-- Name: detailed_calls; Type: VIEW; Schema: public; Owner: iungopbx
...
ALTER TABLE detailed_calls OWNER TO iungopbx;
