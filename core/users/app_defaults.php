	...
	//insert default password reset email template
		if (file_exists($_SERVER['DOCUMENT_ROOT'].'/app/email_templates')) {
			...
			if ($num_rows == 0) {
				...
				$array['email_templates'][$x]['template_body'] .= "A password reset was just requested for the IungoPBX user account associated with this email address.<br /><br />\n";
				...
				$array['email_templates'][$x]['template_body'] .= "<i><b>IungoPBX</b></i><br />\n";
