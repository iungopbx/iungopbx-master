...
$text['login-message_text']['en-us'] = "Keep up with the IungoPBX project by configuring your preferences in the newly added <a href=''/core/notifications/notification_edit.php''>Notifications</a> section, under the System menu!";
$text['login-message_text']['en-gb'] = "Keep up with the IungoPBX project by configuring your preferences in the newly added <a href=''/core/notifications/notification_edit.php''>Notifications</a> section, under the System menu!";
$text['login-message_text']['ar-eg'] = "";
$text['login-message_text']['de-at'] = "Halten Sie sich über IungoPBX auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen."; //copied from de-de
$text['login-message_text']['de-ch'] = "Halten Sie sich über IungoPBX auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen."; //copied from de-de
$text['login-message_text']['de-de'] = "Halten Sie sich über IungoPBX auf dem Laufenden indem Sie die Benachrichtigungseinstellungen im System Menü setzen.";
$text['login-message_text']['es-cl'] = "Manténgase al día con el proyecto IungoPBX configurando sus preferencias en la sección <a href=''/core/notifications/notification_edit.php''>Notificaciones</a> acaba de agregar, en el menú del sistema!";
$text['login-message_text']['es-mx'] = "Manténgase al día con el proyecto IungoPBX configurando sus preferencias en la sección <a href=''/core/notifications/notification_edit.php''>Notificaciones</a> acaba de agregar, en el menú del sistema!"; //copied from es-cl
$text['login-message_text']['fr-ca'] = "Tenez-vous au courant des nouveautés du projet IungoPBX en configurant vos préférences dans la section <a href=''/core/notifications/notification_edit.php''>Notifications</a> , du menu système!"; //copied from fr-fr
$text['login-message_text']['fr-fr'] = "Tenez-vous au courant des nouveautés du projet IungoPBX en configurant vos préférences dans la section <a href=''/core/notifications/notification_edit.php''>Notifications</a> , du menu système!";
$text['login-message_text']['he-il'] = "";
$text['login-message_text']['it-it'] = "Tieniti aggiornato sul progetto IungoPBX configurando le tue preference nella nuova sezione <a href=''/core/notifications/notification_edit.php''>Notifiche</a>, sotto il menu sistema!";
$text['login-message_text']['nl-nl'] = "";
$text['login-message_text']['pl-pl'] = "Bądź na bieżąco z projektem IungoPBX konfigurując swoje preferencje w  nowo dodanej sekcji Powiadomienia w menu System!";
$text['login-message_text']['pt-br'] = "Mantenha-se com o projeto IungoPBX configurando suas preferências na seção <a href=''/core/notifications/notification_edit.php''>Notificações</a> recém-adicionado, no menu Sistema!";
$text['login-message_text']['pt-pt'] = "Mantenha-se com o projeto IungoPBX configurando suas preferências na seção <a href=''/core/notifications/notification_edit.php''>Notificações</a> recém-adicionado, no menu Sistema!";
$text['login-message_text']['ro-ro'] = "";
$text['login-message_text']['ru-ru'] = "Следите за проектом IungoPBX, настроив свои настройки в недавно добавленном разделе <a href=''/core/notifications/notification_edit.php''>Уведомления</a> в меню 'Система'!";
$text['login-message_text']['sv-se'] = "Håll dig uppdaterad med de IungoPBX projektet genom att konfigurera dina inställningar i nytillkomna Notifications avsnitt , under Systemmenyn !";
$text['login-message_text']['uk-ua'] = "Keep up with the IungoPBX project by configuring your preferences in the newly added Notifications section, under the System menu! ";
...
$text['description-upgrade_source']['en-us'] = "Updates IungoPBX source files from the respository.";
$text['description-upgrade_source']['en-gb'] = "Updates IungoPBX source files from the respository.";
$text['description-upgrade_source']['ar-eg'] = "";
$text['description-upgrade_source']['de-at'] = "Aktualisiert den IungoPBX Quellcode aus dem Repository"; //copied from de-de
$text['description-upgrade_source']['de-ch'] = "Aktualisiert den IungoPBX Quellcode aus dem Repository"; //copied from de-de
$text['description-upgrade_source']['de-de'] = "Aktualisiert den IungoPBX Quellcode aus dem Repository";
$text['description-upgrade_source']['es-cl'] = "Archivos de origen Actualizaciones IungoPBX del repositorio.";
$text['description-upgrade_source']['es-mx'] = "Archivos de origen Actualizaciones IungoPBX del repositorio."; //copied from es-cl
$text['description-upgrade_source']['fr-ca'] = "Mise à jour du code source de IungoPBX depuis le dépôt."; //copied from fr-fr
$text['description-upgrade_source']['fr-fr'] = "Mise à jour du code source de IungoPBX depuis le dépôt.";
$text['description-upgrade_source']['he-il'] = "";
$text['description-upgrade_source']['it-it'] = "Aggiorna il files sorgente di IungoPBX dal repository.";
$text['description-upgrade_source']['nl-nl'] = "";
$text['description-upgrade_source']['pl-pl'] = "Uaktualnia pliki źródłowe IungoPBX z przechowalni.";
$text['description-upgrade_source']['pt-br'] = "Atualiza o IungoPBX a partir dos arquivos de código fonte do repositório.";
$text['description-upgrade_source']['pt-pt'] = "Arquivos de origem Atualizações IungoPBX do repositório.";
$text['description-upgrade_source']['ro-ro'] = "";
$text['description-upgrade_source']['ru-ru'] = "Обновляет исходные файлы IungoPBX из репозитория.";
$text['description-upgrade_source']['sv-se'] = "Uppdaterar IungoPBX källfiler från respository.";
$text['description-upgrade_source']['uk-ua'] = "Оновлення вихідних файлів  IungoPBX з репозиторію Subversion .";
