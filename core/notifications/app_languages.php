...
$text['message-demographics']['en-us'] = "<u>Note</u>: To help the IungoPBX project by submitting the demographic information described above <i>without</i> subscribing to Project Notifications, simply ";
$text['message-demographics']['en-gb'] = "<u>Note</u>: To help the IungoPBX project by submitting the demographic information described above <i>without</i> subscribing to Project Notifications, simply ";
$text['message-demographics']['ar-eg'] = "";
$text['message-demographics']['de-at'] = "<u>Anmerkung</u>: Um das IungoPBX Projekt zu unterstützen ohne statistische Informationen über Ihre Installation preiszugeben, "; //copied from de-de
$text['message-demographics']['de-ch'] = "<u>Anmerkung</u>: Um das IungoPBX Projekt zu unterstützen ohne statistische Informationen über Ihre Installation preiszugeben, "; //copied from de-de
$text['message-demographics']['de-de'] = "<u>Anmerkung</u>: Um das IungoPBX Projekt zu unterstützen ohne statistische Informationen über Ihre Installation preiszugeben, ";
$text['message-demographics']['el-gr'] = "<u>Σημείωση</u>: Μπορείτε να προσφέρετε στο IungoPBX project με την υποβολή δημογραφικών πληροφοριών όπως αναφέρονται παραπάνω <i>χωρίς</i> την εγγραφή σας στις γνωστοποιήσεις ";
$text['message-demographics']['es-cl'] = "<u>Nota</u>: Para ayudar al proyecto IungoPBX presentando la informaci髇 demogr醘ica descrita anteriormente sin necesidad de suscribirse a Project Notificaciones, haga ";
$text['message-demographics']['es-mx'] = "<u>Nota</u>: Para ayudar al proyecto IungoPBX presentando la informaci髇 demogr醘ica descrita anteriormente sin necesidad de suscribirse a Project Notificaciones, haga "; //copied from es-cl
$text['message-demographics']['fr-ca'] = "<u>Remarque</u>: Pour aider le projet IungoPBX en soumettant l'information démographique décrit ci-dessus, sans souscrire au Projet Notifications, "; //copied from fr-fr
$text['message-demographics']['fr-fr'] = "<u>Remarque</u>: Pour aider le projet IungoPBX en soumettant l'information démographique décrit ci-dessus, sans souscrire au Projet Notifications, ";
$text['message-demographics']['he-il'] = "";
$text['message-demographics']['it-it'] = "<u>Nota</u>: Per aiutare il progetto IungoPBX fornendo le informazioni demografiche descritte sopra <i>senza</i> abilitare le Notifiche di Progetto, semplicemente ";
$text['message-demographics']['nl-nl'] = "";
$text['message-demographics']['pl-pl'] = "Uwaga: Aby wspom贸c projekt IungoPBX poprzez podanie informacji demograficznych opisanych powy偶ej bez konieczno艣ci aktywowania funkcji Powiadomie艅,";
$text['message-demographics']['pt-br'] = "Nota: Para ajudar o IungoPBX, nos ajude a solucionar o incidente";
$text['message-demographics']['pt-pt'] = "<u>Nota</u>: Para ajudar o projeto IungoPBX, apresentando as informa珲es demogr醘icas descrito acima sem a assinatura do Projeto Notifica珲es, basta ";
$text['message-demographics']['ro-ro'] = "";
$text['message-demographics']['ru-ru'] = "<u>Примечание:</u> Чтобы помочь проекту IungoPBX, отправив статистической информацию, описанную выше, <i>без</i> подписывания на уведомления о проекте, просто";
$text['message-demographics']['sv-se'] = "Obs! För att hjälpa IungoPBX projektet genom att skicka in demografisk information som beskrivs ovan utan att prenumerera på Project Meddelanden , helt enkelt";
...
$text['description-project_releases']['en-us'] = "Receive notifications when new stable version of IungoPBX are released and available for download.";
$text['description-project_releases']['en-gb'] = "Receive notifications when new stable version of IungoPBX are released and available for download.";
$text['description-project_releases']['ar-eg'] = "";
$text['description-project_releases']['de-at'] = "Benachrichtigungen über neue stabile Versionen von IungoPBX erhalten."; //copied from de-de
$text['description-project_releases']['de-ch'] = "Benachrichtigungen über neue stabile Versionen von IungoPBX erhalten."; //copied from de-de
$text['description-project_releases']['de-de'] = "Benachrichtigungen über neue stabile Versionen von IungoPBX erhalten.";
$text['description-project_releases']['el-gr'] = "Λήψη γνωστοποιήσεων με την έκδοση προς ανάκτηση νέας παραγωγικής έκδοσης IungoPBX.";
$text['description-project_releases']['es-cl'] = "Reciba notificaciones cuando una nueva versi髇 estable de IungoPBX se liberan y disponible para su descarga.";
$text['description-project_releases']['es-mx'] = "Reciba notificaciones cuando una nueva versi髇 estable de IungoPBX se liberan y disponible para su descarga."; //copied from es-cl
$text['description-project_releases']['fr-ca'] = "Recevez des alertes lorsque la nouvelle version stable de IungoPBX sont disponibles pour le téléchargement."; //copied from fr-fr
$text['description-project_releases']['fr-fr'] = "Recevez des alertes lorsque la nouvelle version stable de IungoPBX sont disponibles pour le téléchargement.";
$text['description-project_releases']['he-il'] = "";
$text['description-project_releases']['it-it'] = "Ricevi notifiche sulle nuove versioni stabili di IungoPBX che vengono rilasciate per il download.";
$text['description-project_releases']['nl-nl'] = "";
$text['description-project_releases']['pl-pl'] = "Otrzymuj powiadomienia kiedy nowe i stabilne wersje IungoPBX zostaj膮 wydane i dost臋pne do pobrania.";
$text['description-project_releases']['pt-br'] = "Receber notifica莽玫es sobre uma nova vers茫o disponivel para download";
$text['description-project_releases']['pt-pt'] = "Receba notifica珲es quando nova vers鉶 est醰el do IungoPBX s鉶 liberados e dispon韛eis para download.";
$text['description-project_releases']['ro-ro'] = "";
$text['description-project_releases']['ru-ru'] = "Получать уведомления, когда новая стабильная версия IungoPBX выпущена и доступна для загрузки.";
$text['description-project_releases']['sv-se'] = "Ta emot meddelanden när nya stabila versioner av IungoPBX släpps och finns för nedladdning. ";
$text['description-project_releases']['uk-ua'] = "";

$text['description-project_notifications']['en-us'] = "Enable IungoPBX project notifications.";
$text['description-project_notifications']['en-gb'] = "Enable IungoPBX project notifications.";
$text['description-project_notifications']['ar-eg'] = "";
$text['description-project_notifications']['de-at'] = "IungoPBX Projekt-Benachrichtigung aktivieren."; //copied from de-de
$text['description-project_notifications']['de-ch'] = "IungoPBX Projekt-Benachrichtigung aktivieren."; //copied from de-de
$text['description-project_notifications']['de-de'] = "IungoPBX Projekt-Benachrichtigung aktivieren.";
$text['description-project_notifications']['el-gr'] = "Ενεργοποίηση γνωστοποιήσεων για το IungoPBX.";
$text['description-project_notifications']['es-cl'] = "Habilitar las notificaciones de proyectos IungoPBX.";
$text['description-project_notifications']['es-mx'] = "Habilitar las notificaciones de proyectos IungoPBX."; //copied from es-cl
$text['description-project_notifications']['fr-ca'] = "Activer les notifications de projet IungoPBX."; //copied from fr-fr
$text['description-project_notifications']['fr-fr'] = "Activer les notifications de projet IungoPBX.";
$text['description-project_notifications']['he-il'] = "";
$text['description-project_notifications']['it-it'] = "Abilita le notifiche di progetto di IungoPBX.";
$text['description-project_notifications']['nl-nl'] = "";
$text['description-project_notifications']['pl-pl'] = "W艂膮cz powiadomienia projektu IungoPBX.";
$text['description-project_notifications']['pt-br'] = "Ativivar notifica莽玫es do sistema";
$text['description-project_notifications']['pt-pt'] = "Ativar notifica珲es de projetos IungoPBX.";
$text['description-project_notifications']['ro-ro'] = "";
$text['description-project_notifications']['ru-ru'] = "Включить уведомления проекта IungoPBX.";
$text['description-project_notifications']['sv-se'] = "Aktivera IungoPBX projekt meddelanden.";
...
$text['description-project_news']['en-us'] = "Receive notifications of general IungoPBX related news and information.";
$text['description-project_news']['en-gb'] = "Receive notifications of general IungoPBX related news and information.";
$text['description-project_news']['ar-eg'] = "";
$text['description-project_news']['de-at'] = "Allgemeine Informationen über IungoPBX."; //copied from de-de
$text['description-project_news']['de-ch'] = "Allgemeine Informationen über IungoPBX."; //copied from de-de
$text['description-project_news']['de-de'] = "Allgemeine Informationen über IungoPBX.";
$text['description-project_news']['el-gr'] = "Λήψη γνωστοποιήσεων σχετικά με γενικές πληροφορίες περί IungoPBX.";
$text['description-project_news']['es-cl'] = "Recibir notificaciones de noticias IungoPBX relacionadas e informaci髇 general.";
$text['description-project_news']['es-mx'] = "Recibir notificaciones de noticias IungoPBX relacionadas e informaci髇 general."; //copied from es-cl
$text['description-project_news']['fr-ca'] = "Recevoir des notifications de nouvelles et d'information générale liés à IungoPBX."; //copied from fr-fr
$text['description-project_news']['fr-fr'] = "Recevoir des notifications de nouvelles et d'information générale liés à IungoPBX.";
$text['description-project_news']['he-il'] = "";
$text['description-project_news']['it-it'] = "Ricevi le notifiche delle notizie generali su IungoPBX.";
$text['description-project_news']['nl-nl'] = "";
$text['description-project_news']['pl-pl'] = "Otrzymuj og贸lne powiadomienia zawieraj膮ce informacje i nowo艣ci o projekcie IungoPBX.";
$text['description-project_news']['pt-br'] = "Receber notifica莽玫es, not铆cias e informa莽玫es gerais relacionadas ao sistema";
$text['description-project_news']['pt-pt'] = "Receber notifica珲es de not韈ias e informa珲es gerais IungoPBX relacionados.";
$text['description-project_news']['ro-ro'] = "";
$text['description-project_news']['ru-ru'] = "Получать уведомления об общих новостях и информации IungoPBX.";
$text['description-project_news']['sv-se'] = "Ta emot meddelanden om allmänna IungoPBX relaterade nyheter och information.";
$text['description-project_news']['uk-ua'] = "";

$text['description-project_events']['en-us'] = "Receive notifications of upcoming IungoPBX training classes, convention booths, and other events related to the project.";
$text['description-project_events']['en-gb'] = "Receive notifications of upcoming IungoPBX training classes, convention booths, and other events related to the project.";
$text['description-project_events']['ar-eg'] = "";
$text['description-project_events']['de-at'] = "Benachrichtigungen über kommende IungoPBX Schulungen und andere Projektbezogene Veranstaltungen."; //copied from de-de
$text['description-project_events']['de-ch'] = "Benachrichtigungen über kommende IungoPBX Schulungen und andere Projektbezogene Veranstaltungen."; //copied from de-de
$text['description-project_events']['de-de'] = "Benachrichtigungen über kommende IungoPBX Schulungen und andere Projektbezogene Veranstaltungen.";
$text['description-project_events']['el-gr'] = "Λήψη γνωστοποιήσεων σχετικά με επερχόμενα εκπαιδευτικά σεμινάρια και δρώμενα περί IungoPBX.";
$text['description-project_events']['es-cl'] = "Recibir notificaciones de pr髕imas clases IungoPBX formaci髇, cabinas de convenciones y otros eventos relacionados con el proyecto.";
$text['description-project_events']['es-mx'] = "Recibir notificaciones de pr髕imas clases IungoPBX formaci髇, cabinas de convenciones y otros eventos relacionados con el proyecto."; //copied from es-cl
$text['description-project_events']['fr-ca'] = "Recevez des notifications sur les prochains cours de formation IungoPBX, les stands de convention et d'autres événements liés au projet."; //copied from fr-fr
$text['description-project_events']['fr-fr'] = "Recevez des notifications sur les prochains cours de formation IungoPBX, les stands de convention et d'autres événements liés au projet.";
$text['description-project_events']['he-il'] = "";
$text['description-project_events']['it-it'] = "Ricevi le notifiche sui corsi di formazione, le conventions, e altri eventi legati al progetto IungoPBX.";
$text['description-project_events']['nl-nl'] = "";
$text['description-project_events']['pl-pl'] = "Otrzymuj powiadomienia zawieraj膮ce informacje o zbli偶aj膮cych si臋 szkoleniach, zjazdach oraz innych wydarzeniach zwi膮zanych z projektem IungoPBX.";
$text['description-project_events']['pt-br'] = "Receber notifica莽玫es futuros treinamentos sobre o sistema e outros eventos";
$text['description-project_events']['pt-pt'] = "Receber notifica珲es de futuras aulas IungoPBX forma玢o, cabines de conven珲es e outros eventos relacionados ao projeto.";
$text['description-project_events']['ro-ro'] = "";
$text['description-project_events']['ru-ru'] = "Получать уведомления о предстоящих учебных классах IungoPBX, стендах для конференций и других событиях, связанных с проектом.";
$text['description-project_events']['sv-se'] = "Få meddelanden om kommande IungoPBX utbildningar , utställningar och andra händelser relaterade till projektet.";
$text['description-project_events']['uk-ua'] = "";

$text['description-notifications']['en-us'] = "Set notification preferences for IungoPBX project-related communication and other local system alerts.";
$text['description-notifications']['en-gb'] = "Set notification preferences for IungoPBX project-related communication and other local system alerts.";
$text['description-notifications']['ar-eg'] = "";
$text['description-notifications']['de-at'] = "Benachrichtigungseinstellungen für IungoPBX Projektbezogene Informationen."; //copied from de-de
$text['description-notifications']['de-ch'] = "Benachrichtigungseinstellungen für IungoPBX Projektbezogene Informationen."; //copied from de-de
$text['description-notifications']['de-de'] = "Benachrichtigungseinstellungen für IungoPBX Projektbezogene Informationen.";
$text['description-notifications']['el-gr'] = "Ορίστε ρυθμίσεις γνωστοποιήσεων πληροφοριών περί IungoPBX.";
$text['description-notifications']['es-cl'] = "Definici髇 de las preferencias de notificaci髇 de la comunicaci髇 relacionada con el proyecto IungoPBX y otras alertas del sistema local.";
$text['description-notifications']['es-mx'] = "Definici髇 de las preferencias de notificaci髇 de la comunicaci髇 relacionada con el proyecto IungoPBX y otras alertas del sistema local."; //copied from es-cl
$text['description-notifications']['fr-ca'] = "Définir les préférences de notification pour les communications liées au projet IungoPBX et d'autres alertes système locales."; //copied from fr-fr
$text['description-notifications']['fr-fr'] = "Définir les préférences de notification pour les communications liées au projet IungoPBX et d'autres alertes système locales.";
$text['description-notifications']['he-il'] = "";
$text['description-notifications']['it-it'] = "Imposta le preferenze di notifica per le comunicazioni e gli altri sistemi di allerta relativi al progetto IungoPBX.";
$text['description-notifications']['nl-nl'] = "";
$text['description-notifications']['pl-pl'] = "Ustawienia preferencji powiadomie艅 zawieraj膮cych informacje o projekcie IungoPBX i innych lokalnych alertach systemowych.";
$text['description-notifications']['pt-br'] = "Definir prefer锚ncias de notifica莽玫es para a comunica莽茫o relacionada ao sistema";
$text['description-notifications']['pt-pt'] = "Definir prefer阯cias de notifica玢o para a comunica玢o relacionada com o projecto IungoPBX e outros alertas do sistema local.";
$text['description-notifications']['ro-ro'] = "";
$text['description-notifications']['ru-ru'] = "Устанавливать настройки уведомлений для IungoPBX связанных с проектом сообщений и других локальных системных предупреждений.";
$text['description-notifications']['sv-se'] = "Inställningar för IungoPBX relaterade meddelanden och andra lokala system varningar.";
